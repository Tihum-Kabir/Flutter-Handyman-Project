...
class ReportPage extends StatelessWidget {
  ...
  Future<void> _generatePdf(BuildContext context) async {
    ...
    // Determine total time taken.  Use completedAt from orderData if
    // available, otherwise calculate from the current time.  The
    // difference between the start and end times will be displayed in
    // the report.
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate time taken using completedAt if provided or now as fallback
    DateTime endTime;
    final completedVal = orderData['completedAt'];
    if (completedVal is Timestamp) {
      endTime = completedVal.toDate();
